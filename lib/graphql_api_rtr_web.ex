defmodule GraphqlApiRtrWeb do
  ...
  This can be used in your application as:
      ...
      use GraphqlApiRtrWeb, :controller
      use GraphqlApiRtrWeb, :html
  ...
  defp view_helpers do
    quote do
      ...
      import GraphqlApiRtrWeb.ErrorHelpers
      import GraphqlApiRtrWeb.Gettext
      alias GraphqlApiRtrWeb.Router.Helpers, as: Routes
    end
  end
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: GraphqlApiRtrWeb.Router
    end
  end
